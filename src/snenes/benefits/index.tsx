...
function Benefits({setSelectedPage}: Props) {
  ...
  >
    ...
    >
        ...
        {/* Benefits */}
        <motion.div 
            className="md:flex items-center jstify-between gap-8 mt-5"
            initial="hidden"
            whileInView="visible"
            viewport={{once: true, amount: 0.5}}
            variants={container}
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
            ...
            <div>
                ...
                <div className="relative">
                    <div className="before:absolute before:-top-20 before:-left-20 before:-z-[1] before:content-abstract-wave">
                        <motion.div
                        initial="hidden"
                        whileInView="visible"
                        viewport={{once:true, amount:0.5}}
